...
{{/*
*/}}
{{- define "obd-router.bindingName" -}}
{{- printf "%s-%s" (include "obd-router.fullname" .root ) .name }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "obd-router.chart" -}}
...
Common labels
*/}}
{{- define "obd-router.labels" -}}
helm.sh/revision: {{ .Release.Revision | quote }}
helm.sh/chart: {{ include "obd-router.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "obd-router.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "obd-router.selectorLabels" -}}
app.kubernetes.io/name: {{ include "obd-router.name" . }}
...
*/}}
{{- define "obd-router.applicationUri" -}}
{{- include "obd-router.fullname" . }}
{{- end }}

{{/*
Service Binding secret mounts
*/}}
{{- define "obd-router.serviceMounts" -}}
...
*/}}
{{- define "obd-router.serviceVolumes" -}}
{{- range $name, $params := .Values.bindings }}
{{- if ( or ( not (hasKey $params "enabled")) $params.enabled ) }}
{{- $secretName := (include "obd-router.bindingName" (dict "root" $ "name" $name)) }}
...
*/}}
{{- define "obd-router.imagePullSecretName" -}}
...
*/}}
{{- define "obd-router.serviceInstanceName" -}}
