...
{{/*
*/}}
{{- define "susaas-srv.bindingName" -}}
{{- printf "%s-%s" (include "susaas-srv.fullname" .root ) .name }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "susaas-srv.chart" -}}
...
Common labels
*/}}
{{- define "susaas-srv.labels" -}}
helm.sh/revision: {{ .Release.Revision | quote }}
helm.sh/chart: {{ include "susaas-srv.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "susaas-srv.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "susaas-srv.selectorLabels" -}}
app.kubernetes.io/name: {{ include "susaas-srv.name" . }}
...
*/}}
{{- define "susaas-srv.applicationUri" -}}
{{- include "susaas-srv.fullname" . }}
{{- end }}

{{/*
Service Binding secret mounts
*/}}
{{- define "susaas-srv.serviceMounts" -}}
...
*/}}
{{- define "susaas-srv.serviceVolumes" -}}
{{- range $name, $params := .Values.bindings }}
{{- if ( or ( not (hasKey $params "enabled")) $params.enabled ) }}
{{- $secretName := (include "susaas-srv.bindingName" (dict "root" $ "name" $name)) }}
...
*/}}
{{- define "susaas-srv.imagePullSecretName" -}}
...
*/}}
{{- define "susaas-srv.serviceInstanceName" -}}
