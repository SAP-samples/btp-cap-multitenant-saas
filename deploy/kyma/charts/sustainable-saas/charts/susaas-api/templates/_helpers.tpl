...
{{/*
*/}}
{{- define "susaas-api.bindingName" -}}
{{- printf "%s-%s" (include "susaas-api.fullname" .root ) .name }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "susaas-api.chart" -}}
...
Common labels
*/}}
{{- define "susaas-api.labels" -}}
helm.sh/revision: {{ .Release.Revision | quote }}
helm.sh/chart: {{ include "susaas-api.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "susaas-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "susaas-api.selectorLabels" -}}
app.kubernetes.io/name: {{ include "susaas-api.name" . }}
...
*/}}
{{- define "susaas-api.applicationUri" -}}
{{- include "susaas-api.fullname" . }}
{{- end }}

{{/*
Service Binding secret mounts
*/}}
{{- define "susaas-api.serviceMounts" -}}
...
*/}}
{{- define "susaas-api.serviceVolumes" -}}
{{- range $name, $params := .Values.bindings }}
{{- if ( or ( not (hasKey $params "enabled")) $params.enabled ) }}
{{- $secretName := (include "susaas-api.bindingName" (dict "root" $ "name" $name)) }}
...
*/}}
{{- define "susaas-api.imagePullSecretName" -}}
...
*/}}
{{- define "susaas-api.serviceInstanceName" -}}
